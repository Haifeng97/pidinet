...
python main.py --model pidinet --config carv4 --sa --dil --resume --iter-size 1 --batch-size 32 -j 16 --gpu 0 --epochs 20 --lr 0.005 --lr-type multistep --lr-steps 10-16 --wd 1e-4 --savedir ./train_table5/table5_pidinet --datadir ./data/BSDS500 --dataset BSDS #--evaluate /path/to/table5_pidinet.pth
